...
public class Queries {
    ...
    public static final String SQL_SELECT_BOOKS_BY_TITLE_NEXT = "select book_id, title, description, rating, image_url from book2018 where title like ? limit ? offset ?"; 
}
